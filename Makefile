...
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/share/harbour-piano/lib
LIBS          = $(SUBLIBS) -pie -rdynamic -L/usr/lib/ -lsailfishapp -lmdeclarativecache5 -L/usr/lib -lQt5Quick -lQt5Gui -lQt5Qml -lQt5Network -lQt5Core -lGLESv2 -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/harbour-piano.cpp \
		src/RtMidi.cpp moc_qmlpiano.cpp
OBJECTS       = harbour-piano.o \
		RtMidi.o \
		moc_qmlpiano.o
...
Makefile: harbour-piano.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/harbour-piano1.0.0 || mkdir -p .tmp/harbour-piano1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/harbour-piano1.0.0/ && $(COPY_FILE) --parents src/RtMidi.h src/RtError.h src/qmlpiano.hpp .tmp/harbour-piano1.0.0/ && $(COPY_FILE) --parents src/harbour-piano.cpp src/RtMidi.cpp .tmp/harbour-piano1.0.0/ && $(COPY_FILE) --parents translations/harbour-piano-de.ts .tmp/harbour-piano1.0.0/ && (cd `dirname .tmp/harbour-piano1.0.0` && $(TAR) harbour-piano1.0.0.tar harbour-piano1.0.0 && $(COMPRESS) harbour-piano1.0.0.tar) && $(MOVE) `dirname .tmp/harbour-piano1.0.0`/harbour-piano1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/harbour-piano1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_qmlpiano.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qmlpiano.cpp
moc_qmlpiano.cpp: /usr/include/qt5/QtCore/QObject \
		...
		src/RtError.h \
		src/qmlpiano.hpp
	/usr/lib/qt5/bin/moc $(DEFINES) $(INCPATH) -I/opt/cross/armv7hl-meego-linux-gnueabi/include/c++/4.6.4 -I/opt/cross/armv7hl-meego-linux-gnueabi/include/c++/4.6.4/armv7hl-meego-linux-gnueabi -I/opt/cross/armv7hl-meego-linux-gnueabi/include/c++/4.6.4/backward -I/opt/cross/lib/gcc/armv7hl-meego-linux-gnueabi/4.6.4/include -I//usr/local/include -I/opt/cross/lib/gcc/armv7hl-meego-linux-gnueabi/4.6.4/include-fixed -I/opt/cross/armv7hl-meego-linux-gnueabi/include -I//usr/include src/qmlpiano.hpp -o moc_qmlpiano.cpp
...
harbour-piano.o: src/harbour-piano.cpp /usr/include/qt5/QtQuick/QtQuick \
		...
		src/RtMidi.h \
		src/RtError.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o harbour-piano.o src/harbour-piano.cpp

RtMidi.o: src/RtMidi.cpp src/RtMidi.h \
		src/RtError.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o RtMidi.o src/RtMidi.cpp

moc_qmlpiano.o: moc_qmlpiano.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_qmlpiano.o moc_qmlpiano.cpp

####### Install

install_qm: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-piano/translations || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-piano/translations
	lupdate "/home/mersdk/share/git/test/harbour-piano/src" "/home/mersdk/share/git/test/harbour-piano/qml" -ts "/home/mersdk/share/git/test/harbour-piano/translations/harbour-piano.ts" "/home/mersdk/share/git/test/harbour-piano/translations/harbour-piano-de.ts" && mkdir -p translations && [ "/home/mersdk/share/git/test/harbour-piano" != "/home/mersdk/share/git/test/harbour-piano" -a 1 -eq 1 ] && cp -af "/home/mersdk/share/git/test/harbour-piano/translations/harbour-piano-de.ts" "/home/mersdk/share/git/test/harbour-piano/translations" || : ; [ 1 -eq 1 ] && lrelease -nounfinished "/home/mersdk/share/git/test/harbour-piano/translations/harbour-piano-de.ts" || :
	-$(INSTALL_FILE) /home/mersdk/share/git/test/harbour-piano/translations/harbour-piano-de.qm $(INSTALL_ROOT)/usr/share/harbour-piano/translations/

uninstall_qm: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-piano/translations/harbour-piano-de.qm
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-piano/translations/ 


install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-piano || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-piano
	-$(INSTALL_DIR) /home/mersdk/share/git/test/harbour-piano/qml $(INSTALL_ROOT)/usr/share/harbour-piano/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-piano/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-piano/ 
...
install_desktop: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/git/test/harbour-piano/harbour-piano.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-piano.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/git/test/harbour-piano/harbour-piano.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-piano.png
