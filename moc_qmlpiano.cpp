/****************************************************************************
** Meta object code from reading C++ file 'qmlpiano.hpp'
**
...
#include "src/qmlpiano.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'qmlpiano.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(8, 68, 8)
    ...
    "Piano\0octaveChanged\0\0portNameChanged\0"
    "noteOn\0keyIndex\0noteOff\0octave\0portName\0"
};
...
void Piano::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->octaveChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->portNameChanged(); break;
        case 2: _t->noteOn((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->noteOff((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Piano::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Piano::octaveChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Piano::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Piano::portNameChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Piano::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Piano.data,
...
int Piano::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = octave(); break;
        case 1: *reinterpret_cast< QString*>(_v) = portName(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setOctave(*reinterpret_cast< int*>(_v)); break;
        }
        _id -= 2;
...
// SIGNAL 0
void Piano::octaveChanged(int _t1)
{
